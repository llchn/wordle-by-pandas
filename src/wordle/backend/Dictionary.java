...
/**
 * Reads a file and creates a List of English Words and common words. Boolean
 * checks which are valid user guesses and target Wordle game words. Conditions
 * for a valid user guess: 5 letters and found in the list of English words
 * Conditions for a valid target word: 5 letters and found in the list of common
 * words
 * 
 * @author Linda Hu
 * 
...
public class Dictionary {
    ...
    /**
     * Reads files and creates valid Wordle lists of playable words and valid
     * guesses. Checks if a randomly selected word form EnglishWords.txt is a
     * valid user guess, and if it is a valid target word for Game to use.
     * 
     * @param commonWordsFile, String englishWordsFile filenames to be read
     * @return list of playable words and valid guesses.
     */
    public static void filesSetUp(String commonWordsFile,
    ...
    public static String getValidTarget() {
        // Check and add all valid target words from EnglishWords.txt to a new
        // list
    ...
    /**
     * Creates a new list of only the 5 letter words from a pre-existing list of
     * words
     * 
    ...
    /**
     * A valid target word is 5 letters, and found in both common_words.txt and
     * EnglishWords.txt files
     * 
     * @param targetWord potential Wordle guessing word to be checked
     * @return true if word meets the conditions, false if not.
     */
    public static boolean isValidTarget(String targetWord) {
        // isValidGuess already checks if word is a 5 letter word found in
        // EnglishWords.txt
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Dictionary successfully loaded. # of valid words "
                + validWordleGuesses.size());
